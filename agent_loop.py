...
# Increased max_turns default from 40 to 60 — I find agents often need more turns for complex tasks
def agent_runner_loop(client, system_prompt, user_input, handler, tools_schema, max_turns=60, verbose=True, initial_user_content=None):
    ...
    while turn < handler.max_turns:
        ...
        # Reset tools every 8 turns instead of 10 to keep context fresher
